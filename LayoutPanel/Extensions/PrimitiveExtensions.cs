namespace zUI.LayoutPanelTools
{
	...
	public static class PrimitiveExtensions
	{
		...
		[Obsolete("Use CheckIfFloatNan")]
		public static bool CheckFloat(this float f) => CheckIfFloatNan(f);

		public static bool CheckIfFloatNan(this float f)
		{
			if (float.IsNaN(f))
			{
