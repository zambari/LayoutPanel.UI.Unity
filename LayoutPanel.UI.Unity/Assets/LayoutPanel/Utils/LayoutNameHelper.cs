...
public class LayoutNameHelper : MonoBehaviour
{
    ...
    public void NameTagHandling(bool show)
    {
        showDepth = show;
        string n = name;
        //if (show)
    ...
    void OnEnable()
    {
        ...
        var cre = GetComponentInParent<LayoutCreator>();
        if (cre != null)
        {
            showDepth = cre.tagObjectNamesWithDepth;
        }
        UpdateNameF();
    }
