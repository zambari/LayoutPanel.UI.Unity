...
namespace LayoutPanelDependencies
{
    ...
    // to avoid conflicts, extensions actually used by layoutpanel have been moved here
    ...
    public static class zExtensionsLayout
    {
        ...
        */
        ...
        public static Image AddImageChild(this GameObject g, float opacity = 0.3f)
        {
            ...
            image.color = new Color(UnityEngine.Random.value * 0.3f + 0.7f,
                                       UnityEngine.Random.value * 0.3f + 0.7f,
                                       UnityEngine.Random.value * 0.2f, opacity);
