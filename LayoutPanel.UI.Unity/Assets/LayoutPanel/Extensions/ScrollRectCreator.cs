...
namespace Z.LayoutPanel
{
	...
	public static class ScrollRectCreator
	{
		public static RectTransform CreateScrollView(this GameObject target)
		{
			return CreateScrollView(target.transform);
		}

		public static RectTransform CreateScrollView(this Transform target)
		{
			...
			vertlayout.childControlWidth = childControlWidth;
			...
			scrollview1_scrollRect.horizontal = false;
			scrollview1_scrollRect.verticalScrollbar = scrollRect_scrollbarvertical;
			return scrollview1_scrollRect.content;
