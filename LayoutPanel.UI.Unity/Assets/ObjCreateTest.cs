...
// 		rectTransform_scrollview1.anchorMin = new Vector2(0f, 1f);
// 		rectTransform_scrollview1.anchorMax = new Vector2(0f, 1f);
// 		rectTransform_scrollview1.offsetMin = new Vector2(139.2438f, -420.0568f);
// 		rectTransform_scrollview1.offsetMax = new Vector2(534.3551f, -226.0248f);
// 		rectTransform_scrollview1.anchoredPosition = new Vector2(336.7994f, -323.0408f);
//
// 		// LayoutElement 
...
// 		rectTransform_viewport.offsetMax = new Vector2(-7f, 0f);
...
// 		text__some_content_0.fontSize = 23;
...
// 		text__some_content_1.fontSize = 23;
...
// 		scrollbarvertical_image.color = new Color(1f, 1f, 1f, 1f);
// 		scrollbarvertical_image.type = Image.Type.Sliced;
//
// 		// RectTransform 
...
// 		rectTransform_scrollbarvertical.offsetMin = new Vector2(-10f, 0f);
...
// 		handle_image.color = new Color(0.3480923f, 0.990566f, 0.1439124f, 1f);
// 		handle_image.type = Image.Type.Sliced;
//
// 		// RectTransform 
// 		var rectTransform_handle = handle.GetComponent<RectTransform>();
// 		rectTransform_handle.anchorMin = new Vector2(0f, 0.2238724f);
